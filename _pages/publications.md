...
* __Pinciroli, R.__, Yang, L., Alter, J., and Smirni, E. (2021). "Lifespan and Failures of SSDs and HDDs: Similarities, Differences, and Prediction Models". In _IEEE Transactions on Dependable and Secure Computing_, (Early Access).<br/>\[[DOI](https://doi.org/10.1109/TDSC.2021.3131571){:target="_blank"}\] - \[[PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9629263){:target="_blank"}\] - \[[BibTeX](pinciroli2021lifespan.html){:target="_blank"}\]
